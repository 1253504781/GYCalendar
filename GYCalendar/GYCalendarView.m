...
- (void)setupCollectionView
{
    ...
    // 注册基础展示日期cell
    [collectionView registerNib:[UINib nibWithNibName:NSStringFromClass([GYDateCell class]) bundle:nil] forCellWithReuseIdentifier:ID];
    [collectionView registerNib:[UINib nibWithNibName:NSStringFromClass([GYDateHeader class]) bundle:nil] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:headerID];
